...
public class ModPlaceFeatures {
    ...
    public static final ResourceKey<PlacedFeature> BURGER_ORE_PLACED_KEY = registerKey("burger_ore_placed");
    public static final ResourceKey<PlacedFeature> END_BURGER_ORE_PLACED_KEY = registerKey("end_burger_ore_placed");
    ...
    private static ResourceKey<PlacedFeature> registerKey(String name) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(BurgerMod.MOD_ID, name));
    }
